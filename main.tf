...
variable "lastname" {
  default = "fatima" # REPLACE with your actual last name
}
variable "github_repo" {
  default = "Muskaan-30/deploy-assignment3" # REPLACE with your GitHub user/repo
}
variable "codestar_arn" {
  default = "arn:aws:codeconnections:us-east-1:075737418482:connection/80940d2a-9179-432d-ab22-b8b15eac3520" # REPLACE with your copied ARN
}
